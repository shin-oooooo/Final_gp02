...
This article is aligned with the Phase 0 main column beta bar chart: `figure_title="Figure0.3"` (`dash_app/app.py` calls `fig_beta_regime_compare`). Placeholders `**{benchmark}**` · `**—**` · `**—**` · `**—**` · `**—**` can be injected by Caption/`_fmt_vars` or snapshot parsing.
