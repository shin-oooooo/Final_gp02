...
Placeholders: `**{n_symbols}**` · `**{defense_level}**` · `**{objective_name}**` (can be injected aligned with snapshot `**snap_json["phase3"]**` / `**snap_json["defense_level"]**`). See `**Figure3.2-Inv.md**` for the investment narrative.
...
**Placeholder**: `**{n_symbols}`** · `**{defense_level}`** · `**{objective_name}`**